...
![CI](https://github.com/hkevin01/grant-ai/actions/workflows/ci.yml/badge.svg)
...
- ✅ Crash-free operation via robust GUI threading
- ✅ Enhanced scrapers for WV Department of Education and foundations
- ✅ Organized codebase with professional project structure and testing
- ✅ Built-in performance analysis and improvement recommendations
...
### 🔍 Grant Search & Discovery - IMPROVED
...
git clone https://github.com/hkevin01/grant-ai.git
cd grant-ai
...
./run.sh format                # Auto-format code (black + isort)
```
...
- **Vulnerability Reporting**: Email [security@grant-ai.org](mailto:security@grant-ai.org)
