...
class PlatformIntegration(ABC):
    ...
    @abstractmethod
    async def discover_grants(self, organization: OrganizationProfile, 
                            criteria: Dict[str, Any]) -> IntegrationResult:
...
class GrantPlatformIntegrationManager:
    ...
    def _initialize_platforms(self):
        ...
        try:
            ...
            from grant_ai.integrations.simple_open_grants import (
                SimpleOpenGrantsIntegration,
            )
            ...
            try:
                from grant_ai.integrations.community_force import (
                    CommunityForceIntegration,
                )
    ...
    async def discover_grants_multi_platform(self, 
                                           organization: OrganizationProfile,
                                           platforms: Optional[List[str]] = None,
                                           criteria: Optional[Dict[str, Any]] = None) -> List[IntegrationResult]:
        """
