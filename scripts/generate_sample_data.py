...
def create_sample_grants() -> list[Grant]:
    ...
    grants.append(Grant(
        ...
        eligibility_types=[EligibilityType.NONPROFIT, EligibilityType.COMMUNITY],
        focus_areas=["housing", "affordable housing", "seniors", "families", "community development"],
...
def create_sample_ai_companies() -> list[AICompany]:
    ...
    companies.append(AICompany(
        ...
        ai_focus_areas=[AIFocusArea.MACHINE_LEARNING, AIFocusArea.COMPUTER_VISION, AIFocusArea.NATURAL_LANGUAGE],
        has_grant_program=True,
    ...
    companies.append(AICompany(
        ...
        ai_focus_areas=[AIFocusArea.MACHINE_LEARNING, AIFocusArea.NATURAL_LANGUAGE, AIFocusArea.COMPUTER_VISION],
        has_grant_program=True,
        grant_program_name="AI for Good",
        grant_program_url="https://microsoft.com/ai-for-good",
        grant_focus_areas=["accessibility", "humanitarian action", "cultural heritage", "earth"],
